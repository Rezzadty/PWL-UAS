		...
		<div class="row">
			<div class="col-lg-6">
				...
				<?= form_input(['type' => 'hidden', 'name' => 'total_harga', 'id' => 'total_harga', 'value' => '']) ?>
					<div class="col-12">
						<label for="nama" class="form-label">Buyer Name</label>
					...
					<div class="col-12">
						<label for="kabkota" class="form-label">counties/cities</label> 
						<select class="form-select" id="kabupaten">
							<option>Choose Your counties / cities</option> 
						</select>
					</div> 
					<div class="col-12">
						<label for="layanan" class="form-label">Service</label> 
						<select class="form-select" id="service">
							<option>Choose Your Service</option> 
						</select>
					</div> 
					<div class="col-12">
						<label for="ongkir" class="form-label">Postage</label>
