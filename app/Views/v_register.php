			...
			<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
				...
				<div class="d-flex justify-content-center py-4">
					<a href="index.html" class="logo d-flex align-items-center w-auto">
						...
						<span class="d-none d-lg-block">llty Shop</span>
					</a>
				</div><!-- End Logo -->
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<div class="pt-4 pb-2">
							...
							<p class="text-center small">Make Account and Password</p>
						</div>
						...
						<div class="col-12">
							<?= form_submit('submit', 'Sign Up', ['class' => 'btn btn-primary w-100']) ?>
						</div>
						<div class="col-12">
							<p class="small mb-0">Already Have an Account ? Click <a href="<?php echo base_url('login') ?>"> Login</a></p>
						</div>
						<?= form_close() ?>
